...
function About() {
  ...
  return (
    <main className="flex flex-col items-center gap-24 bg-brand-secondary px-8 py-14 transition-colors duration-1000 dark:bg-brand-primary-dark dark:text-brand-secondary">
      <div className="flex flex-col items-center justify-center">
        ...
        <ul className="mt-4 flex gap-4">
          ...
          >
            <Link
              href="https://www.linkedin.com/in/mashrafie-rahim-sheikh-6aa3631a1/"
              target="_blank"
            >
              <svg
                viewBox="0 0 128 128"
          ...
          <motion.li
            ...
            className={`${listStyle}`}
          >
            <Link href="https://github.com/m3tal10" target="_blank">
              <svg
                viewBox="0 0 128 128"
          ...
          >
            <Link
              href="https://www.facebook.com/Mashrafieee.Rahim"
              target="_blank"
            >
              <svg
                viewBox="0 0 128 128"
          ...
          <motion.li
            ...
            className={`${listStyle}`}
          >
            <Link href="https://leetcode.com/u/M3TAL10/" target="_blank">
              <svg
      ...
      <div className="flex w-full flex-col gap-3 border-t-2 pt-20">
        ...
        <ul className="grid grid-cols-3 gap-2 lg:grid-cols-4 lg:gap-8">
          {/* HTML */}
          <motion.li
            whileHover={{
              scale: 1.05,
        ...
        <ul className="grid grid-cols-3 gap-2 lg:grid-cols-4 lg:gap-8">
          ...
          <motion.li whileHover={skillsHover} className={skillIconStyle}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
              ...
              />
              <path
                // style="fill:#850000;fill-opacity:1;fillRule:nonzero;stroke:none"
                fill={darkMode ? `#f5f5f4` : `#082f49`}
                fillOpacity={1}
                fillRule="nonzero"
                stroke="none"
      ...
      <div className="flex w-full flex-col gap-3 border-t-2 pt-20 dark:text-brand-primary-dark">
        ...
        <p className="flex items-center justify-between text-base">
          <span className="rounded-md bg-brand-primary px-2">Residence :</span>
