...
function Navbar() {
  ...
  const navIconStyle =
    "h-full w-full fill-text-light p-2 transition-all duration-300 hover:fill-brand-primary-dark";
  ...
  return (
    <nav className="dark:bg-brand-primary-dark fixed bottom-0 right-0 flex h-full flex-col items-center gap-44 bg-stone-100 px-10 py-14 transition-colors duration-1000 dark:text-brand-secondary">
      ...
      >
        {darkMode ? (
          ...
          <svg
            ...
            viewBox="0 0 30 30"
            xmlns="http://www.w3.org/2000/svg"
            className={`hover:fill-brand-primary-dark fill-text-light transition-transform duration-1000 hover:rotate-180`}
          >
      ...
      <ul className="flex flex-col items-center gap-10">
        {/* Home Icon*/}
        <Link href="/">
          <li className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 transition-all duration-200 hover:bg-brand-primary">
            <svg
              viewBox="0 0 18 18"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="hover:fill-brand-primary-dark h-full w-full fill-text-light p-2 transition-all duration-200"
            >
